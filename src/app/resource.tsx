...
export const MARCS: number =
  (AVERAGE_REIMBURSEMENT.MrGBP + AVERAGE_REIMBURSEMENT.MrVSG + AVERAGE_REIMBURSEMENT.MrDS + AVERAGE_REIMBURSEMENT.MrAGB) + AVERAGE_REIMBURSEMENT.MrEGD + AVERAGE_REIMBURSEMENT.MrConsult;
